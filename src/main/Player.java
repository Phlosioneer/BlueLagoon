...
public class Player {
	...
	int getTotalScore() {
		return getRockScore() + getGemScore() + getWoodScore() + getBreadScore() + getGoldScore() + getSetBonusScore() + getIslandsVisitedScore() + islandsControlledScore + getLongestChainScore() + previousRoundScore;
	}
}
